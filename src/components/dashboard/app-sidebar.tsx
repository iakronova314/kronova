        ...
        >
          ...
          {!collapsed && (
            <div className="min-w-0 flex-1">
              ...
              <p className="truncate text-xs text-muted-foreground">{{owner:'Propietario',admin:'Administrador',analyst:'Analista',viewer:'Lector'}[activeOrganization.role]} · {user.email}</p>
            </div>
          )}
        </div>
      </div>
